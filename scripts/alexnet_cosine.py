...
wandb.init(id = id, resume = "allow", project="alexnet_cosine", entity="siddsuresh97", settings=wandb.Settings(code_dir="vision_robustness_using_semantic_norms/src/alexnet_mse.py")) 
config = wandb.config
                    ...
                    with torch.no_grad():
                        ...
                        for val_imgs, val_classes in val_dataloader:
                            ...
                            # this is done to create a negative sample
                                ...
                                val_loss += loss_func(val_output, target)
                        ...
                        for test_imgs, test_classes in test_dataloader:
                            ...
                            # this is done to create a negative sample
                                ...
                                test_loss += loss_func(test_output, target)
